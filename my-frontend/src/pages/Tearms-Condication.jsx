  ...
  return (
    <div className="min-h-screen bg-gray-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto bg-white p-10 rounded-lg shadow-lg">
        <h1 className="text-4xl font-bold text-indigo-600 mb-8">Terms & Conditions</h1>
        <div className="space-y-8">
          <section>
            <h2 className="text-2xl font-semibold text-teal-600 mb-4">A. Electronic Record</h2>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-teal-600 mb-4">B. Publishing Information</h2>
            <p className="text-gray-700">
              ...
              regulations, privacy policy and Terms of Use for access or usage of domain name Bitcoinify
              (bitcoinify.global), including the related mobile site and mobile application (hereinafter referred
              to as “Platform”).
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-teal-600 mb-4">C. Platform Ownership</h2>
            <p className="text-gray-700">
              The Platform is owned by iWebGenics, a company incorporated under the Companies Act.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-teal-600 mb-4">D. Terms of Use</h2>
            <p className="text-gray-700">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-teal-600 mb-4">E. User Definitions</h2>
            <p className="text-gray-700">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-teal-600 mb-4">F. User Agreement</h2>
            <p className="text-gray-700">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-teal-600 mb-4">G. Terms of Use</h2>
            <div className="text-gray-700 space-y-4">
              <p>
                I. To access and use the Services, you agree to provide true, accurate and complete information to
              ...
              <p>
                II. Neither we nor any third parties provide any warranty or guarantee as to the accuracy,
              ...
              <p>
                III. Your use of our Services and the Platform is solely and entirely at your own risk and discretion for
              ...
              <p>
                IV. The contents of the Platform and the Services are proprietary to us and are licensed to us. You
                will not have any authority to claim any intellectual property rights, title, or interest in its
                contents. The contents includes and is not limited to the design, layout, look and graphics.
              </p>
              <p>
                V. You acknowledge that unauthorized use of the Platform and/or the Services may lead to action
              ...
              <p>
                VII. You agree not to use the Platform and/ or Services for any purpose that is unlawful, illegal or
                forbidden by these Terms, or Indian or local laws that might apply to you.
              </p>
              <p>
                VIII. You agree and acknowledge that website and the Services may contain links to other third party
              ...
              <p>
                IX. You understand that upon initiating a transaction for availing the Services you are entering into a
                legally binding and enforceable contract with the Platform Owner for the Services.
              </p>
              <p>
                X. You shall indemnify and hold harmless Platform Owner, its affiliates, group companies (as
              ...
              <p>
                XI. In no event will the Platform Owner be liable for any indirect, consequential, incidental, special
                ...
                interests, whether in contract, negligence, tort or otherwise, arising from the use of or inability to
                use the Services, however caused and whether arising in contract, tort, negligence, warranty or
                otherwise, exceed the amount paid by You for using the Services giving rise to the cause of action
                or Rupees One Hundred (Rs. 100) whichever is less
              </p>
              <p>
                XII. Notwithstanding anything contained in these Terms of Use, the parties shall not be liable for any
                failure to perform an obligation under these Terms if performance is prevented or delayed by a
                force majeure event.
              </p>
              <p>
                XIII. These Terms and any dispute or claim relating to it, or its enforceability, shall be governed by and
                construed in accordance with the laws of India.
              </p>
              <p>
                XIV. All disputes arising out of or in connection with these Terms shall be subject to the exclusive
                jurisdiction of the courts in Kolkata.
              </p>
              <p>
                XV. All concerns or communications relating to these Terms must be communicated to us using the
