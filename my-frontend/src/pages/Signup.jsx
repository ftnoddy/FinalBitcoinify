      ...
      <main className="flex-1 bg-gradient-to-br from-[#8e2de2] to-[#4a00e0] px-4 sm:px-6 py-12">
        <div className="mx-auto max-w-4xl">
          <div className="mb-6 flex flex-col items-center justify-center gap-6">
            <h1 className="text-4xl font-bold text-white">Welcome to CryptoTracker</h1>
            <p className="text-lg text-white">
              Track your cryptocurrency investments and stay up-to-date with the latest market trends.
            </p>
